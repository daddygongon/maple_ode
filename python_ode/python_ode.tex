...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k}{def} \PY{n+nf}{euler}\PY{p}{(}\PY{n}{x0}\PY{p}{,} \PY{n}{v0}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{g}\PY{p}{,} \PY{n}{dt}\PY{p}{,} \PY{n}{cc}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mf}{0.1}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}5}]:} <matplotlib.animation.FuncAnimation at 0x1195bee48>
\end{Verbatim}
...
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{euler2}\PY{p}{(}\PY{n}{x0}\PY{p}{,} \PY{n}{v0}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{g}\PY{p}{,} \PY{n}{dt}\PY{p}{,} \PY{n}{cc}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mf}{0.1}
        \PY{n}{tt}\PY{p}{,}\PY{n}{xx}\PY{p}{,}\PY{n}{vv}\PY{o}{=}\PY{p}{[}\PY{l+m+mf}{0.0}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mf}{10.0}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mf}{0.0}\PY{p}{]}
        \PY{n}{t} \PY{o}{=} \PY{l+m+mf}{0.0}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{:}
          \PY{n}{t} \PY{o}{+}\PY{o}{=} \PY{n}{dt}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{anim}
\end{Verbatim}

            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} <matplotlib.animation.FuncAnimation at 0x11a0c7fd0>
\end{Verbatim}
...
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k}{def} \PY{n+nf}{euler3}\PY{p}{(}\PY{n}{x0}\PY{p}{,}\PY{n}{v0}\PY{p}{)}\PY{p}{:}
...
\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{k}{def} \PY{n+nf}{runge\PYZus{}kutta4}\PY{p}{(}\PY{n}{x0}\PY{p}{,}\PY{n}{y0}\PY{p}{,}\PY{n}{z0}\PY{p}{,}\PY{n}{h}\PY{p}{)}\PY{p}{:}
...
この変数の書き換えを吸収する中間関数としてEuler3を書き換えます．RungeKutta4の仮引数を上の表に従って置き換えて，数値を渡しています．また，関数\(f,g\)も定義しておきます．
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{k}{def} \PY{n+nf}{ff}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{x}\PY{p}{,}\PY{n}{v}\PY{p}{)}\PY{p}{:}
           \PY{k}{return} \PY{n}{v}
...
発散も収束もすることなく，定常的に振動を繰り返していることが見て取れます．
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{c+c1}{\PYZsh{} \PYZpc{}notebook inline}
         \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
         \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{animation} \PY{k}{as} \PY{n+nn}{animation}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{anim}
\end{Verbatim}

            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}42}]:} <matplotlib.animation.FuncAnimation at 0x11b4e4940>
\end{Verbatim}
