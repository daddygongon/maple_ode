...
なる連立方程式を解くことに置き換わります．これをMapleで関数にして，さらに計算結果を表示させてみます．
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n+no}{Euler3} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{x\PYZus{}i}\PY{p}{,} \PY{n}{v\PYZus{}i}\PY{p}{)}
          \PY{n}{local} \PY{n}{v\PYZus{}ip1}\PY{p}{,} \PY{n}{x\PYZus{}ip1}\PY{p}{;}
          \PY{n}{global} \PY{n}{k}\PY{p}{,} \PY{n}{cc}\PY{p}{,} \PY{n}{dx}\PY{p}{;}
          \PY{n}{v\PYZus{}ip1} \PY{p}{:}\PY{o}{=} \PY{n}{v\PYZus{}i} \PY{o}{+} \PY{p}{(}\PY{o}{\PYZhy{}} \PY{n}{k} \PY{o}{*} \PY{n}{x\PYZus{}i}\PY{p}{)} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{n}{x\PYZus{}ip1} \PY{p}{:}\PY{o}{=} \PY{n}{x\PYZus{}i} \PY{o}{+} \PY{n}{v\PYZus{}i} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{k}{return} \PY{n}{x\PYZus{}ip1}\PY{p}{,} \PY{n}{v\PYZus{}ip1}\PY{p}{;}
        \PY{k}{end}\PY{p}{;}
...
一般にRunge-Kutta法と呼ばれる手法は，4次の古典的Runge-Kutta法を指します．導出は意外と面倒なので，2次の場合のさわりを紹介して，そこからの類推としましょう．
...
\[
\begin{aligned}
\theta&=0のとき，& \Delta y &\simeq hy'(x_0) \\
\theta&=1のとき，& \Delta y &\simeq hy'(x_0+h) 
\end{aligned}
\]
...
微分方程式 \[
\frac{dy}{dx} = f(x,y), 初期条件y(x_0)=y_0
\]
...
連立微分方程式 \[
\begin{aligned}
\frac{dy}{dx} &= f(x,y,z), &\, 初期条件y(x_0)=y_0 \\
\frac{dz}{dx} &= g(x,y,z), &\, 初期条件z(x_0)=z_0 \\
\end{aligned}
\]
...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{ff} \PY{p}{:}\PY{o}{=} \PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{x}\PY{p}{,}\PY{n}{v}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}} \PY{n}{v}\PY{p}{;}
        ...
        \PY{n+no}{Euler3} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{x\PYZus{}i}\PY{p}{,} \PY{n}{v\PYZus{}i}\PY{p}{)}
          \PY{n}{local} \PY{n}{v\PYZus{}ip1}\PY{p}{,} \PY{n}{x\PYZus{}ip1}\PY{p}{,} \PY{n}{kk}\PY{p}{,} \PY{n}{ll}\PY{p}{;}
          \PY{n}{global} \PY{n}{dt}\PY{p}{;}
          \PY{n}{kk}\PY{p}{,}\PY{n}{ll} \PY{p}{:}\PY{o}{=} \PY{n+no}{RungeKutta4}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{x\PYZus{}i}\PY{p}{,}\PY{n}{v\PYZus{}i}\PY{p}{,}\PY{n}{dt}\PY{p}{)}\PY{p}{;}
          \PY{l+s+ss}{x\PYZus{}ip1}\PY{p}{:}\PY{o}{=} \PY{n}{x\PYZus{}i}\PY{o}{+}\PY{n}{kk}\PY{p}{;}
          \PY{l+s+ss}{v\PYZus{}ip1}\PY{p}{:}\PY{o}{=} \PY{n}{v\PYZus{}i}\PY{o}{+}\PY{n}{ll}\PY{p}{;}
          \PY{k}{return} \PY{n}{x\PYZus{}ip1}\PY{p}{,} \PY{n}{v\PYZus{}ip1}\PY{p}{;}
        \PY{k}{end}\PY{p}{;}
\end{Verbatim}
