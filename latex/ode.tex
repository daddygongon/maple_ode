...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{restart}\PY{p}{;}
        \PY{n+no}{Euler2} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{q\PYZus{}i}\PY{p}{,} \PY{n}{i\PYZus{}i}\PY{p}{)}
          \PY{n}{local} \PY{n}{q\PYZus{}ip1}\PY{p}{,} \PY{n}{i\PYZus{}ip1}\PY{p}{;}
          \PY{n}{global} \PY{n}{dt}\PY{p}{,} \PY{n+no}{RR}\PY{p}{,} \PY{n}{qc}\PY{p}{;}
          \PY{n}{i\PYZus{}ip1} \PY{p}{:}\PY{o}{=} \PY{n}{i\PYZus{}i} \PY{o}{+} \PY{p}{(}\PY{n}{V} \PY{o}{\PYZhy{}} \PY{n+no}{RR} \PY{o}{*} \PY{n}{i\PYZus{}i} \PY{o}{\PYZhy{}} \PY{n}{qc} \PY{o}{*} \PY{n}{q\PYZus{}i}\PY{p}{)} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{n}{q\PYZus{}ip1} \PY{p}{:}\PY{o}{=} \PY{n}{q\PYZus{}i} \PY{o}{+} \PY{n}{i\PYZus{}i} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{k}{return} \PY{n}{q\PYZus{}ip1}\PY{p}{,} \PY{n}{i\PYZus{}ip1}\PY{p}{;}
        \PY{k}{end}\PY{p}{;}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{l+s+ss}{dt}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mo}{01}\PY{p}{;}\PY{l+s+ss}{RR}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{5}\PY{p}{;}\PY{l+s+ss}{qc}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{;}\PY{l+s+ss}{V}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{;}
        \PY{l+s+ss}{ii}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;}
        \PY{l+s+ss}{qq}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;} 
        ...
        \PY{k}{end} \PY{k}{do}\PY{p}{:}
        \PY{n}{with}\PY{p}{(}\PY{n}{plots}\PY{p}{)}\PY{p}{:}
        \PY{n}{listplot}\PY{p}{(}\PY{n}{qq}\PY{p}{)}\PY{p}{;}\PY{n}{listplot}\PY{p}{(}\PY{n}{ii}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
\begin{figure}[htbp]
\centering
\includegraphics{../figs/rlc_circuitplot2d1.jpg}
\caption{rlc\_circuit\_q\_plot}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{../figs/rlc_circuitplot2d2.jpg}
\caption{rlc\_circuit\_i\_plot}
\end{figure}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{l+s+ss}{dt}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mo}{01}\PY{p}{;}\PY{l+s+ss}{RR}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{5}\PY{p}{;}\PY{l+s+ss}{qc}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{;}\PY{l+s+ss}{V}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{;}
        \PY{l+s+ss}{ii}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;}
        \PY{l+s+ss}{qq}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{;} 
        \PY{k}{for} \PY{n}{i} \PY{n}{from} \PY{l+m+mi}{2} \PY{n}{to} \PY{l+m+mi}{2000} \PY{k}{do}
          \PY{n}{q}\PY{p}{,} \PY{n}{i2} \PY{p}{:}\PY{o}{=} \PY{n+no}{Euler2}\PY{p}{(}\PY{n}{qq}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{,}\PY{n}{ii}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{)}\PY{p}{;}
          \PY{n}{qq} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{qq}\PY{p}{)}\PY{p}{,}\PY{n}{q}\PY{o}{]}\PY{p}{;} 
          \PY{n}{ii} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{ii}\PY{p}{)}\PY{p}{,}\PY{n}{i2}\PY{o}{]}\PY{p}{;} 
...
\begin{figure}[htbp]
\centering
\includegraphics{../figs/rlc_circuitplot2d3.jpg}
\caption{rlc\_circuit\_q\_plot}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{../figs/rlc_circuitplot2d4.jpg}
\caption{rlc\_circuit\_i\_plot}
\end{figure}
