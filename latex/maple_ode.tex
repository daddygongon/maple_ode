...
{\color{incolor}In [{\color{incolor} }]:} \PY{n+no}{Euler} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{x0}\PY{p}{,} \PY{n}{v0}\PY{p}{)}
          \PY{n}{local} \PY{n}{v1}\PY{p}{,} \PY{n}{x1}\PY{p}{;}
          \PY{n}{global} \PY{n}{g}\PY{p}{,} \PY{n}{dt}\PY{p}{;}
          \PY{n}{v1} \PY{p}{:}\PY{o}{=} \PY{n}{v0} \PY{o}{\PYZhy{}} \PY{n}{g} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{n}{x1} \PY{p}{:}\PY{o}{=} \PY{n}{x0} \PY{o}{+} \PY{n}{v0} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{k}{return} \PY{n}{x1}\PY{p}{,} \PY{n}{v1}\PY{p}{;}
        \PY{k}{end}\PY{p}{:}
\end{Verbatim}
...
x\_i+1を順次計算して返します．結果は，
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{l+s+ss}{dt}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{1}\PY{p}{;}\PY{l+s+ss}{g}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{9}\PY{o}{.}\PY{l+m+mi}{8}\PY{p}{;} 
        \PY{n}{tt}\PY{p}{,}\PY{n}{vv}\PY{p}{,}\PY{l+s+ss}{xx}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{10}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;}
        \PY{k}{for} \PY{n}{i} \PY{n}{from} \PY{l+m+mi}{2} \PY{n}{to} \PY{l+m+mi}{50} \PY{k}{do}
          ...
          \PY{n}{tt} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{tt}\PY{p}{)}\PY{p}{,}\PY{n}{tt}\PY{o}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{o}{+}\PY{n}{dt}\PY{o}{]}\PY{p}{;}
        ...
        \PY{l+s+ss}{lx}\PY{p}{:}\PY{o}{=}\PY{n}{listplot}\PY{p}{(}\PY{o}{[}\PY{n}{tt}\PY{p}{,}\PY{n}{xx}\PY{o}{]}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}blue\PYZsq{}}\PY{p}{)}\PY{p}{;}
        \PY{l+s+ss}{lv}\PY{p}{:}\PY{o}{=}\PY{n}{listplot}\PY{p}{(}\PY{o}{[}\PY{n}{tt}\PY{p}{,}\PY{n}{vv}\PY{o}{]}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}red\PYZsq{}}\PY{p}{)}\PY{p}{;}
        \PY{n+nb}{display}\PY{p}{(}\PY{n}{lx}\PY{p}{,}\PY{n}{lv}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
\caption{euler\_ball\_drop free gravitation fall}
\end{figure}
...
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n+no}{Euler2} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{x0}\PY{p}{,} \PY{n}{v0}\PY{p}{)}
          \PY{n}{local} \PY{n}{v1}\PY{p}{,} \PY{n}{x1}\PY{p}{;}
          \PY{n}{global} \PY{n}{g}\PY{p}{,} \PY{n}{dt}\PY{p}{;}
          \PY{n}{v1} \PY{p}{:}\PY{o}{=} \PY{n}{v0} \PY{o}{+} \PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{cc} \PY{o}{*} \PY{n}{v0}\PY{o}{\PYZhy{}} \PY{n}{g}\PY{p}{)} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{n}{x1} \PY{p}{:}\PY{o}{=} \PY{n}{x0} \PY{o}{+} \PY{n}{v0} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{k}{return} \PY{n}{x1}\PY{p}{,} \PY{n}{v1}\PY{p}{;}
        \PY{k}{end}\PY{p}{:}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{l+s+ss}{dt}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{1}\PY{p}{:} \PY{l+s+ss}{g}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{9}\PY{o}{.}\PY{l+m+mi}{8}\PY{p}{:} \PY{l+s+ss}{cc}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{:}
        \PY{n}{tt}\PY{p}{,}\PY{n}{vv}\PY{p}{,}\PY{l+s+ss}{xx}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{10}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;}
        \PY{k}{for} \PY{n}{i} \PY{n}{from} \PY{l+m+mi}{2} \PY{n}{to} \PY{l+m+mi}{50} \PY{k}{do}
          \PY{n}{x}\PY{p}{,} \PY{n}{v} \PY{p}{:}\PY{o}{=} \PY{n+no}{Euler2}\PY{p}{(}\PY{n}{xx}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{,}\PY{n}{vv}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{)}\PY{p}{;}
          \PY{n}{tt} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{tt}\PY{p}{)}\PY{p}{,}\PY{n}{tt}\PY{o}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{o}{+}\PY{n}{dt}\PY{o}{]}\PY{p}{;}
          \PY{n}{xx} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{xx}\PY{p}{)}\PY{p}{,}\PY{n}{x}\PY{o}{]}\PY{p}{;} 
          \PY{n}{vv} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{vv}\PY{p}{)}\PY{p}{,}\PY{n}{v}\PY{o}{]}\PY{p}{;} 
        \PY{k}{end} \PY{k}{do}\PY{p}{:}
...
\caption{euler\_ball\_drop with air resistance}
\end{figure}
...
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n+no}{Euler3} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{x0}\PY{p}{,} \PY{n}{v0}\PY{p}{)}
          \PY{n}{local} \PY{n}{v1}\PY{p}{,} \PY{n}{x1}\PY{p}{;}
          \PY{n}{global} \PY{n}{k}\PY{p}{,} \PY{n}{dx}\PY{p}{;}
          \PY{n}{v1} \PY{p}{:}\PY{o}{=} \PY{n}{v0} \PY{o}{+} \PY{p}{(}\PY{o}{\PYZhy{}} \PY{n}{k} \PY{o}{*} \PY{n}{x0} \PY{p}{)} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{n}{x1} \PY{p}{:}\PY{o}{=} \PY{n}{x0} \PY{o}{+} \PY{n}{v0} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{k}{return} \PY{n}{x1}\PY{p}{,} \PY{n}{v1}\PY{p}{;}
        \PY{k}{end}\PY{p}{:}
        ...
        \PY{n}{tt}\PY{p}{,}\PY{n}{vv}\PY{p}{,}\PY{l+s+ss}{xx}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{10}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;}
        \PY{k}{for} \PY{n}{i} \PY{n}{from} \PY{l+m+mi}{2} \PY{n}{to} \PY{l+m+mi}{5000} \PY{k}{do}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{ff} \PY{p}{:}\PY{o}{=} \PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{x}\PY{p}{,}\PY{n}{v}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}} \PY{n}{v}\PY{p}{;}
        ...
        \PY{n}{ode} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{x0}\PY{p}{,} \PY{n}{v0}\PY{p}{)}
          \PY{n}{local} \PY{n}{v1}\PY{p}{,} \PY{n}{x1}\PY{p}{,} \PY{n}{kk}\PY{p}{,} \PY{n}{ll}\PY{p}{;}
          \PY{n}{kk}\PY{p}{,}\PY{n}{ll} \PY{p}{:}\PY{o}{=} \PY{n+no}{RungeKutta4}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{x0}\PY{p}{,}\PY{n}{v0}\PY{p}{,}\PY{n}{dt}\PY{p}{)}\PY{p}{;}
          \PY{l+s+ss}{x1}\PY{p}{:}\PY{o}{=} \PY{n}{x0}\PY{o}{+}\PY{n}{kk}\PY{p}{;}
          \PY{l+s+ss}{v1}\PY{p}{:}\PY{o}{=} \PY{n}{v0}\PY{o}{+}\PY{n}{ll}\PY{p}{;}
          \PY{k}{return} \PY{n}{x1}\PY{p}{,} \PY{n}{v1}\PY{p}{;}
        \PY{k}{end}\PY{p}{:}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{l+s+ss}{dt}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{1}\PY{p}{;}\PY{l+s+ss}{k}\PY{p}{:}\PY{o}{=}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mo}{01}\PY{p}{;}
        \PY{n}{tt}\PY{p}{,}\PY{n}{vv}\PY{p}{,}\PY{l+s+ss}{xx}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{10}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;}
        \PY{k}{for} \PY{n}{i} \PY{n}{from} \PY{l+m+mi}{2} \PY{n}{to} \PY{l+m+mi}{5000} \PY{k}{do}
          \PY{n}{x}\PY{p}{,} \PY{n}{v} \PY{p}{:}\PY{o}{=} \PY{n}{ode}\PY{p}{(}\PY{n}{xx}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{,}\PY{n}{vv}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{)}\PY{p}{;}
          \PY{n}{tt} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{tt}\PY{p}{)}\PY{p}{,}\PY{n}{tt}\PY{o}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{o}{+}\PY{n}{dt}\PY{o}{]}\PY{p}{;}
          \PY{n}{xx} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{xx}\PY{p}{)}\PY{p}{,}\PY{n}{x}\PY{o}{]}\PY{p}{;} 
          \PY{n}{vv} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{vv}\PY{p}{)}\PY{p}{,}\PY{n}{v}\PY{o}{]}\PY{p}{;} 
        \PY{k}{end} \PY{k}{do}\PY{p}{:}
...
\caption{spring oscillation by Runge-Kutta 4th order}
\end{figure}
...
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{restart}\PY{p}{;}
        \PY{n+no}{Euler2} \PY{p}{:}\PY{o}{=} \PY{n+nb}{proc} \PY{p}{(}\PY{n}{q0}\PY{p}{,} \PY{n}{i0}\PY{p}{)}
          \PY{n}{local} \PY{n}{q1}\PY{p}{,} \PY{n}{i1}\PY{p}{;}
          \PY{n}{global} \PY{n}{r}\PY{p}{,}\PY{n}{qc}\PY{p}{,}\PY{n}{v}\PY{p}{,}\PY{n}{dt}\PY{p}{;}
          \PY{n}{i1} \PY{p}{:}\PY{o}{=} \PY{n}{i0} \PY{o}{+} \PY{p}{(}\PY{n}{v} \PY{o}{\PYZhy{}} \PY{n}{r}\PY{o}{*}\PY{n}{i0} \PY{o}{\PYZhy{}}\PY{n}{qc}\PY{o}{*}\PY{n}{q0}\PY{p}{)} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{n}{q1} \PY{p}{:}\PY{o}{=} \PY{n}{q0} \PY{o}{+} \PY{n}{i0} \PY{o}{*} \PY{n}{dt}\PY{p}{;}
          \PY{k}{return} \PY{n}{q1}\PY{p}{,} \PY{n}{i1}\PY{p}{;}
        \PY{k}{end}\PY{p}{;}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{dt}\PY{p}{,}\PY{n}{r}\PY{p}{,} \PY{n}{qc}\PY{p}{,}\PY{n}{v} \PY{p}{:}\PY{o}{=} \PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mo}{01}\PY{p}{,} \PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{5} \PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{;}
        \PY{n}{tt}\PY{p}{,}\PY{n}{ii}\PY{p}{,}\PY{l+s+ss}{qq}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{;}
        \PY{k}{for} \PY{n}{i} \PY{n}{from} \PY{l+m+mi}{2} \PY{n}{to} \PY{l+m+mi}{2000} \PY{k}{do}
          \PY{n}{q}\PY{p}{,} \PY{n}{i2} \PY{p}{:}\PY{o}{=} \PY{n+no}{Euler2}\PY{p}{(}\PY{n}{qq}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{,}\PY{n}{ii}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{)}\PY{p}{;}
          \PY{n}{tt} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{tt}\PY{p}{)}\PY{p}{,}\PY{n}{tt}\PY{o}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{o}{+}\PY{n}{dt}\PY{o}{]}\PY{p}{;}
          \PY{n}{qq} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{qq}\PY{p}{)}\PY{p}{,}\PY{n}{q}\PY{o}{]}\PY{p}{;} 
          \PY{n}{ii} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{ii}\PY{p}{)}\PY{p}{,}\PY{n}{i2}\PY{o}{]}\PY{p}{;} 
        \PY{k}{end} \PY{k}{do}\PY{p}{:}
        
        \PY{n}{with}\PY{p}{(}\PY{n}{plots}\PY{p}{)}\PY{p}{:}
        \PY{l+s+ss}{lx}\PY{p}{:}\PY{o}{=}\PY{n}{listplot}\PY{p}{(}\PY{o}{[}\PY{n}{tt}\PY{p}{,}\PY{n}{qq}\PY{o}{]}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}blue\PYZsq{}}\PY{p}{)}\PY{p}{;}
        \PY{l+s+ss}{lv}\PY{p}{:}\PY{o}{=}\PY{n}{listplot}\PY{p}{(}\PY{o}{[}\PY{n}{tt}\PY{p}{,}\PY{n}{ii}\PY{o}{]}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}red\PYZsq{}}\PY{p}{)}\PY{p}{;}
        \PY{n+nb}{display}\PY{p}{(}\PY{n}{lx}\PY{p}{,}\PY{n}{lv}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
\begin{figure}[htbp]
\centering
\includegraphics{../figs/Euler_ball_dropplot2d5.jpg}
\caption{condenser charge in rlc\_circuit}
\end{figure}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{dt}\PY{p}{,}\PY{n}{r}\PY{p}{,} \PY{n}{qc}\PY{p}{,}\PY{n}{v} \PY{p}{:}\PY{o}{=} \PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mo}{01}\PY{p}{,} \PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{5} \PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{;}
        \PY{n}{tt}\PY{p}{,}\PY{n}{ii}\PY{p}{,}\PY{l+s+ss}{qq}\PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{0}\PY{o}{.}\PY{l+m+mi}{0}\PY{o}{]}\PY{p}{,}\PY{o}{[}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{;}
        \PY{k}{for} \PY{n}{i} \PY{n}{from} \PY{l+m+mi}{2} \PY{n}{to} \PY{l+m+mi}{2000} \PY{k}{do}
          \PY{n}{q}\PY{p}{,} \PY{n}{i2} \PY{p}{:}\PY{o}{=} \PY{n+no}{Euler2}\PY{p}{(}\PY{n}{qq}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{,}\PY{n}{ii}\PY{o}{[}\PY{n}{i}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{p}{)}\PY{p}{;}
          \PY{n}{tt} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{tt}\PY{p}{)}\PY{p}{,}\PY{n}{tt}\PY{o}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{]}\PY{o}{+}\PY{n}{dt}\PY{o}{]}\PY{p}{;}
          \PY{n}{qq} \PY{p}{:}\PY{o}{=}\PY{o}{[}\PY{n}{op}\PY{p}{(}\PY{n}{qq}\PY{p}{)}\PY{p}{,}\PY{n}{q}\PY{o}{]}\PY{p}{;} 
...
\begin{figure}[htbp]
\centering
\includegraphics{../figs/Euler_ball_dropplot2d6.jpg}
\caption{condenser discharge in rlc\_circuit}
\end{figure}
